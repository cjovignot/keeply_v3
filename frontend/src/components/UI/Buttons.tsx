...
const variants: Record<ButtonVariant, string> = {
  ...
  outlined_accent:
    "bg-yellow-400 border-2 border-yellow-400 text-gray-900 rounded-lg p-2 gap-1",
  outlined_danger:
    "bg-transparent border-2 border-red-400 text-red-400 rounded-lg p-2 gap-1",
  outlined_success:
    "bg-transparent border-2 border-yellow-400 text-yellow-400 rounded-lg p-2 gap-1",
  sm_outlined_accent:
    "bg-yellow-400 border-2 border-yellow-400 text-gray-900 rounded-full py-1 px-2 gap-1",
  sm_outlined_danger:
    "bg-transparent border-2 border-red-400 text-red-400 rounded-full py-1 px-2 gap-1",
